                ...
                <div class="row">
                    ...
                    <div class="col-sm-6 offset-sm-1">
                        <ul class="article-list">
                            <li><a href="">TV Shows & Movies</a></li>
                            <li><a href="">Your plan will determine</a></li>
                            <li><a href="">If you choose to remain a member of</a></li>
                            <li><a href="">Your plan will determine</a></li>
                            <li><a href="">If you choose to remain a member of</a></li>
                        </ul>
                        <div class="content-block-bottom">
                            ...
                            <a href="" class="butn btn-cta1b btn-lg">Contact us</a>
                        </div>
                    </div>
                </div>
            </div>
