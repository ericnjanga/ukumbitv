        ...
        <div class="large-12 columns">
            <nav aria-label="You are here:" role="navigation">
                <ul class="breadcrumbs">
                    ...
                    <li>
                        <span class="show-for-sr">{{tr('current')}}: </span> {{tr('spam_videos')}}
                    </li>
                </ul>
            </nav>
        </div>
                    ...
                    @include('layouts.user.notification')
                     ...
                     @if(count($model) > 0)
                        ...
                        <div class="row column head-text clearfix">
                            ...
                            <h4 class="pull-left">
                                <i class="fa fa-heart"></i>{{tr('spam_videos')}}
                            </h4>
                            ...
                            <div class="grid-system pull-right show-for-large">
                                ...
                                <!-- <h4 class="pull-right" style="margin-left:5px">
                                    <a class="" onclick="return confirm('Are you sure?');" href=""><i class="fa fa-trash"></i></a>
                                </h4>
                                        ...
                                        <div class="item large-4 medium-6 columns list">
                                            ...
                                            <div class="post thumb-border">
                                                ...
                                                <div class="post-thumb">
                                                    ...
                                                    <a target="_blank" href="{{route('user.single' , $video->video_id)}}" class="hover-posts">
                                                        <span><i class="fa fa-play"></i>{{tr('spam_videos')}}</span>
                                                    </a>
                                                ...
                                                <div class="post-des">
                                                    <h6><a href="{{route('user.single' , $video->video_id)}}">{{$video->adminVideo->title}}</a></h6>
                                                    ...
                                                    <div class="post-button">
                                                        ...
                                                        <a target="_blank" href="{{route('user.single' , $video->video_id)}}" class="secondary-button">
                                                            <i class="fa fa-play-circle"></i>{{tr('spam_videos')}}
                                                        </a>

                                                        <a  onclick="return confirm('Are you sure?');" href="{{route('user.remove.report_video' ,$video->id)}}" class="secondary-button">
