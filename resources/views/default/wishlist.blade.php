        ...
        <div class="large-12 columns">
            <nav aria-label="You are here:" role="navigation">
                <ul class="breadcrumbs">
                    ...
                    <li>
                        <span class="show-for-sr">{{tr('current')}}: </span> {{tr('wishlist')}}
                    </li>
                </ul>
            </nav>
        </div>
                        ...
                        <div class="row column head-text clearfix">
                            ...
                            <div class="grid-system pull-right show-for-large">
                                ...
                                <h4 class="pull-right" style="margin-left:5px">
                                    <a class="" onclick="return confirm('Are you sure?');" href="{{route('user.delete.wishlist' , array('status' => 1))}}"><i class="fa fa-trash"></i></a>
                                </h4>
                                            ...
                                            <div class="post thumb-border">
                                                ...
                                                <div class="post-des">
                                                    ...
                                                    <div class="post-button">
                                                        ...
                                                        <a  onclick="return confirm('Are you sure?');" href="{{route('user.delete.wishlist' , array('wishlist_id' => $video->wishlist_id))}}" class="secondary-button">
