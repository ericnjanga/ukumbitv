                                    ...
                                    <tr>
                                        ...
                                        <td width="400" align="center" style="padding-bottom:5px;">
                                            <div class="contentEditableContainer contentTextEditable">
                                                <div class="contentEditable" >
                                                    <p >
                                                        "{{trans('messages.Welcome_to')}} {{Setting::get('site_name' , 'Stream Hash')}}.
                                                    </p>
                                                    <br />

                                                    <p>Your Email :  @if(isset($email_data)) {{$email_data['email']}}@endif </p>

                                                    <p>Your Password : @if(isset($email_data)){{$email_data['password']}} @endif</p>
                                                </div>
                                            </div>
                                        </td>
                                        <td width="100">&nbsp;</td>
