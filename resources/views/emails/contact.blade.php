...
<body>
  ...
  <table border="0" width="100%">
  	<tr>
  		<td style="color:#666; font-weight:bold;" width="120px; padding: 10px;">Category:</td>
  		<td style="color:#000; padding: 10px;">{{$email_data->category}}</td>
  	</tr>
  	<tr>
  		<td style="color:#666; font-weight:bold;" width="120px; padding: 10px;">Email from:</td>
  		<td style="color:#000; padding: 10px;">{{$email_data->email}}</td>
  	</tr>
  	<tr>
  		<td style="color:#666; font-weight:bold;" width="120px; padding: 10px;">Message:</td>
