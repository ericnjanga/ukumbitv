                                        ...
                                        <td width="200" valign="top" align="center">
                                            <div class="contentEditableContainer contentTextEditable">
                                                <div class="contentEditable" >
                                                    <img src="@if(Setting::get('site_logo')) {{Setting::get('site_logo' )}} @else {{ asset('logo.png')}} @endif" width="100%" height='100%' alt='Logo'  data-default="placeholder" />
                                                </div>
                                            </div>
                                        </td>
                                        <td width="200" valign="top">&nbsp;</td>
                                            ...
                                            <div class="contentEditableContainer contentTextEditable">
                                                ...
                                                <div class="contentEditable" >
                                                    ...
                                                    @if(isset($email_data))
                                                        ...
                                                        <p>IP Address : {{$email_data->ip_address}} </p>
                                                        <br />

                                                        <p>Remote Address :  {{$email_data->REMOTE_ADDR}} </p>
                                                        <br />

                                                        <p>HTTP_USER_AGENT : {{$email_data->HTTP_USER_AGENT}}  </p>
                                                        <br />

                                                        <p>latitude : {{$email_data->latitude}} </p>
                                                        <br />

                                                        <p>longitude : {{$email_data->longitude}} </p>
                                                        <br />

                                                        <p>Origin : {{$email_data->origin}} </p>
                                                        <br />

                                                        <p>City : {{$email_data->city}} </p>
                                                        <br />

                                                        <p>Region : {{$email_data->region}} </p>
                                                        <br />

                                                        <p>Country : {{$email_data->country}}  </p>
                                                        <br />
