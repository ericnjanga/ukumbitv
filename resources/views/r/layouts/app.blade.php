...
<html lang="en">
	<head>
	  ...
	  <script id="loadcss">
		  ...
		  loadCSS( "https://fonts.googleapis.com/css?family=Roboto:100,300,300i,400,500,500i,700,900", document.getElementById("loadcss") );
		  loadCSS( "https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css", document.getElementById("loadcss") );
		  loadCSS( "https://cdnjs.cloudflare.com/ajax/libs/sweetalert/1.1.3/sweetalert.min.css", document.getElementById("loadcss") );
		  loadCSS( "{{asset('r/css/style.css')}}", document.getElementById("loadcss") );
		  loadCSS( "{{asset('r/css/style.css.map')}}", document.getElementById("loadcss") );
		</script>
		<!-- Reducing render blocking CSS -->
		<!-- Reducing render blocking CSS -->
		<!-- Reducing render blocking CSS -->
