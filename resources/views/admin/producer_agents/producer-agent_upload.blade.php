...
@section('content-header', 'Add agent')
...
@section('breadcrumb')
    ...
    <li><a href="{{route('admin.producer-agents')}}"><i class="fa fa-video-camera"></i>Producer agents</a></li>
@endsection
...
@section('content')
    ...
    <button class="btn btn-primary btn-info-full" id="finishBtn" onclick="createAgent()">Finish</button>
            ...
            if (check >= 0 && check <=100) {
                $.ajax({
                    ...
                    success: function(data){
                        ...
                        console.log(rep);
                        alert('Agent successful created!');
                    },
                    error: function (data) {
                        alert('error '+data);
                    }
