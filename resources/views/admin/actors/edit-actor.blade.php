...
@section('content-header', 'Edit actor')

@section('breadcrumb')
    <li><a href="{{route('admin.dashboard')}}"><i class="fa fa-dashboard"></i>{{tr('home')}}</a></li>
    <li><a href="{{route('admin.actors')}}"><i class="fa fa-suitcase"></i> Actors</a></li>
    <li class="active">{{tr('edit_actor')}}</li>
@endsection
...
@section('content')
        ...
        <div class="col-md-10">
            ...
            <div class="box box-primary">
                ...
                <div class="box-header label-primary">
                    <b style="font-size:18px;">Edit actor</b>
                    <a href="{{route('admin.add.actor')}}" class="btn btn-default pull-right">{{tr('add_actor')}}</a>
                </div>
                ...
                <form class="form-horizontal" method="POST" enctype="multipart/form-data" role="form">
                    ...
                    <div class="box-body">
                        ...
                        <input type="hidden" id="actorid" name="id" value="{{$actor->id}}">

                        <div class="form-group">
                            <label for="name" class="col-sm-1 control-label">{{tr('name')}}</label>
                            <div class="col-sm-10">
                                <input type="text" required class="form-control" value="{{$actor->name}}" id="name" name="name">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <textarea type="text" required class="form-control" id="bio" name="bio">{{$actor->bio}}</textarea>
                            </div>
                        </div>
    ...
    <div class="box-footer">
        ...
        <button class="btn btn-primary btn-info-full" id="finishBtn" onclick="editActor()">Save</button>
    </div>
@endsection
