                        ...
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            @foreach($producers as $i => $producer)
                                ...
                                <tr id="row{{$producer->id}}">
                                    ...
                                    <td>
                                        <a href="edit-movie-producer/{{$producer->id}}" class="btn btn-primary" data-toggle="tooltip" data-placement="top" title="Edit record"><i class="fa fa-pencil" aria-hidden="true"></i></a>
                                        <button class="btn btn-danger" onclick="return confirmDelete({{$producer->id}});" data-toggle="tooltip" data-placement="top" title="Delete record"><i class="fa fa-trash" aria-hidden="true"></i></button>
                                    </td>
                                </tr>
