...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-md-4 col-md-offset-8 form-group">
            <button class="btn btn-submit btn-block" id="finishBtn" onclick="createEpisode({{$video->id}})">Save</button>
        </div>
        ...
        function createEpisode(id) {
            ...
            $.ajax({
                ...
                success: function(data){
                    ...
                    console.log(rep);
                    $( '.overlay' ).css( 'display', 'none' );
                    swal("Great!", "Episode successfully added", "success");
                },
                error: function (data) {
                    $( '.overlay' ).css( 'display', 'none' );
                    swal("Hmmm...", "Something went wrong, try later", "error");
