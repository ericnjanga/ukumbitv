    ...
    <div class="row">
      <ul id="og-grid" class="og-grid video-content list-unstyled clearfix">
        @foreach($videos as $video)
          ...
          -->
            <a href="{{url('/')}}/watch/{{$video->watchid}}" data-largesrc="http://via.placeholder.com/1000x660/250/ffffff/000000" data-title="{{$video->title}}" data-description="{{$video->description}}">
