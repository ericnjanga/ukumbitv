    ...
    <div class="row">
      <ul id="og-grid" class="og-grid video-content list-unstyled clearfix">
        @foreach($videos as $video)
          ...
          -->
            <a href="{{url('/')}}/watch/{{$video->watchid}}" data-largesrc="{{$video->videoimage->imgPreview}}" data-title="{{$video->title}}" data-description="{{$video->description}}" data-year="{{$video->year}}" data-duration="{{$video->duration}}">
